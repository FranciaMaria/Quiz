...
class QuizzsControllerTest < ActionController::TestCase
  ...
  test "should create quizz" do
    assert_difference('Quizz.count') do
      post :create, quizz: { ans1: @quizz.ans1, ans2: @quizz.ans2, ans3: @quizz.ans3, correctAns: @quizz.correctAns, question: @quizz.question }
    end
  ...
  test "should update quizz" do
    patch :update, id: @quizz, quizz: { ans1: @quizz.ans1, ans2: @quizz.ans2, ans3: @quizz.ans3, correctAns: @quizz.correctAns, question: @quizz.question }
    assert_redirected_to quizz_path(assigns(:quizz))
  end
